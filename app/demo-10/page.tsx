...
<section class="banner-section3 fix bg-cover" style="background-image: url('/demo-10/assets/img/banner/bg-color3.jpg');">
<div class="container">
<div class="row g-5 justify-content-between">
<div class="col-xxl-7 col-xl-7 col-md-11 order-2 order-lg-1">
<div class="hero-content-version3">
<span class="cmn-tag p1-bg heading-font mb-xxl-1 mb-3">Dental Clinic</span>
...
<span class="position-relative z-1 w-100">
              ...
              Services<br/> &amp; Surgery
              <img alt="icon" class="img-icon" src="/demo-10/assets/img/banner/icon3_1.svg"/>
</h1>
...
<a class="common-btn box-style text-nowrap d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold white p2-bg overflow-hidden rounded100 wow fadeInRight" data-wow-delay="0.8s" href="/demo-10/pricing">
                  Make Appoinment
...
<img alt="shape-img" src="/demo-10/assets/img/banner/shape3_2.png"/>
</div>
<div class="thumb-shape-2">
<img alt="shape-img" src="/demo-10/assets/img/banner/shape3_1.png"/>
</div>
<div class="thumb-shape-3">
<img alt="shape-img" src="/demo-10/assets/img/banner/search-shape.png"/>
</div>
<div class="thumb">
<img alt="thumb" src="/demo-10/assets/img/banner/hero3-thumb.png"/>
</div>
...
<div class="swiper-slide w-fit">
<div class="text-slide-item">
<img alt="icon" src="/demo-10/assets/img/icon/star-text.png"/>
</div>
</div>
<div class="swiper-slide w-fit">
<div class="text-slide-item">
...
<img alt="img" class="overflow-hidden w-100" src="/demo-10/assets/img/service/service3-v1.jpg"/>
</div>
<div class="service-content">
<h3 class="black"><a href="/demo-10/service-details">Quality Care Service</a></h3>
<p class="pra">
                Health care is a vital aspect maintaining overall well-being, encompassing a range
              </p>
<div class="service-btn-inner">
<a class="common-btn box-style first-box d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold black overflow-hidden white-bg rounded100" href="/demo-10/service-details">
                  Read More
...
<div class="service-item3 overflow-hidden white-bg rounded-4 position-relative">
<div class="thumb overflow-hidden reveal-left position-relative">
<img alt="img" class="overflow-hidden w-100" src="/demo-10/assets/img/service/service3-v2.jpg"/>
</div>
<div class="service-content">
<h3 class="black"><a href="/demo-10/service-details">Your Wellness Priority</a></h3>
<p class="pra">
                Health care is a vital aspect maintaining overall well-being, encompassing a range
              </p>
<div class="service-btn-inner">
...
<div class="service-item3 overflow-hidden white-bg rounded-4 position-relative">
<div class="thumb overflow-hidden reveal-left position-relative">
<img alt="img" class="overflow-hidden w-100" src="/demo-10/assets/img/service/service3-v3.jpg"/>
</div>
<div class="service-content">
<h3 class="black"><a href="/demo-10/service-details">Caring for You Always</a></h3>
<p class="pra">
                Health care is a vital aspect maintaining overall well-being, encompassing a range
              </p>
<div class="service-btn-inner">
...
<img alt="element" class="d-sm-block d-none" src="/demo-10/assets/img/element/pra-element.png"/>
...
<a class="common-btn box-style first-box d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold black overflow-hidden rounded100" href="/demo-10/about">
                  Read More
                  <img alt="icon" src="/demo-10/assets/img/icon/arrow-right-black.png"/>
</a>
</div>
...
<h1>Schedule</h1>
<p>We use advanced 3D intraoral scanners, digital X-rays, and laser dental instruments. check-ups,
...
<div class="thumb">
<img alt="thumb" src="/demo-10/assets/img/team/teamThumb3_1.jpg"/>
</div>
<div class="team-content align-items-end">
<h3><a href="/demo-10/doctor-details">Dr. Sarah Mitchell</a></h3>
<p>Orthodontist & D.D.S.</p>
...
<div class="team-items-info3">
<div class="thumb">
<img alt="thumb" src="/demo-10/assets/img/team/teamThumb3_2.jpg"/>
</div>
<div class="team-content align-items-end">
<h3><a href="/demo-10/doctor-details">Dr. David Vance</a></h3>
...
<div class="team-items-info3">
<div class="thumb">
<img alt="thumb" src="/demo-10/assets/img/team/teamThumb3_3.jpg"/>
</div>
<div class="team-content align-items-end">
<h3><a href="/demo-10/doctor-details">Dr. Emily Taylor</a></h3>
...
<div class="thumb">
<img alt="thumb" src="/demo-10/assets/img/testimonial/testimonialthumb3_1.png"/>
</div>
<div class="author-details">
<h3>Michael Ramirez</h3>
<div class="icon">
<img alt="icon" src="/demo-10/assets/img/testimonial/quote-icons3.png"/>
</div>
<span>Ceo</span>
</div>
...
<h2 class="wow fadeInUp black visible-slowly-right" data-wow-delay=".3s">
            Smile Makeovers & Case Studies<br/>Our Successful Transformations
          </h2>
</div>
<div class="array-button d-flex align-items-center gap-3 wow fadeInUp" data-wow-delay=".5s">
<button class="array-prev d-center">
<img alt="icon" src="/demo-10/assets/img/icon/arrow-left-black.png"/>
</button>
...
<div class="thumb">
<img alt="thumb" src="/demo-10/assets/img/project/projectThumb3_1.png"/>
</div>
<div class="content">
<h4><a href="/demo-10/project-details">Full Mouth Implant Reconstruction</a></h4>
<div class="btn-wrapper">
<a class="cmn-arrows1 link-btn d-center" href="/demo-10/project-details">
<img alt="icon" src="/demo-10/assets/img/icon/arrow-right-black.png"/>
</a>
</div>
</div>
...
<div class="latest-project-slide3">
<div class="thumb">
<img alt="thumb" src="/demo-10/assets/img/project/projectThumb3_2.png"/>
</div>
<div class="content">
<h4><a href="/demo-10/project-details">Clear Aligner Teeth Straightening</a></h4>
<div class="btn-wrapper">
<a class="cmn-arrows1 link-btn d-center" href="/demo-10/project-details">
<img alt="icon" src="/demo-10/assets/img/icon/arrow-right-black.png"/>
</a>
...
<div class="latest-project-slide3">
<div class="thumb">
<img alt="thumb" src="/demo-10/assets/img/project/projectThumb3_3.png"/>
</div>
<div class="content">
<h4><a href="/demo-10/project-details">Premium Porcelain Veneers Makeover</a></h4>
<div class="btn-wrapper">
<a class="cmn-arrows1 link-btn d-center" href="/demo-10/project-details">
<img alt="icon" src="/demo-10/assets/img/icon/arrow-right-black.png"/>
</a>
...
<div class="latest-project-slide3">
<div class="thumb">
<img alt="thumb" src="/demo-10/assets/img/project/projectThumb3_4.png"/>
</div>
<div class="content">
<h4><a href="/demo-10/project-details">Advanced Laser Gum Therapy</a></h4>
<div class="btn-wrapper">
<a class="cmn-arrows1 link-btn d-center" href="/demo-10/project-details">
<img alt="icon" src="/demo-10/assets/img/icon/arrow-right-black.png"/>
</a>
...
<div class="content">
<h2>State-of-the-Art Dental Technology</h2>
<p>Dental care focuses on maintaining oral health through practices such as regular </p>
<div class="feature-btn-inner">
<a class="common-btn box-style first-box d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold black overflow-hidden rounded100" href="/demo-10/service-details">
                    Read More
                    <img alt="icon" src="/demo-10/assets/img/icon/arrow-right-black.png"/>
</a>
</div>
...
<div class="icon">
<img alt="icon" src="/demo-10/assets/img/feature/featureIcon3_1.png"/>
</div>
</div>
</div>
<div class="col-xl-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
<div class="feature-thumb">
<img alt="thumb" src="/demo-10/assets/img/feature/featureThumb3_1.png"/>
</div>
</div>
...
<div class="feature-inner-items2 reveal-left bg-cover rounded-4" style="background-image: url('/demo-10/assets/img/feature/featureThumb3_2.png');">
<div class="content">
...
<a class="common-btn box-style w-100 first-box d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold black overflow-hidden bg-color rounded100" href="/demo-10/pricing">
                  Book An Appiontment
                  <img alt="icon" src="/demo-10/assets/img/icon/arrow-right-black.png"/>
</a>
</div>
...
<a class="common-btn box-style w-100 text-nowrap d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold white p2-bg overflow-hidden rounded100 wow fadeInRight" data-wow-delay="0.8s" href="/demo-10/pricing">
                  Book An Appiontment
                  <img alt="icon" src="/demo-10/assets/img/icon/arrow-right-white.png"/>
</a>
</div>
...
<img alt="img" class="w-100 rounded-2" src="/demo-10/assets/img/appiontment/appiontmentThumb3_1.png"/>
</div>
</div>
<div class="col-lg-6">
<div class="section-title">
...
<img alt="img" class="rounded-4" src="/demo-10/assets/img/blog/blog3-v1.jpg"/>
...
<div class="content">
<h3 class="mb-3">
<a class="black" href="/demo-10/blog-details">Fresh Breath Dental Studio Pearly Whites Dentistry</a>
</h3>
...
<a class="common-btn box-style first-box d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold black overflow-hidden bg-color rounded100" href="/demo-10/blog-details">
                Read More
                <img alt="icon" src="/demo-10/assets/img/icon/arrow-right-black.png"/>
</a>
</div>
...
<div class="blog-items3">
<div class="thumb rounded-4 position-relative mb-3">
<img alt="img" class="rounded-4" src="/demo-10/assets/img/blog/blog3-v2.jpg"/>
<div class="d-flex gap-1 align-items-center blog-date">
<div class="icon d-center"><i class="fa-solid fa-calendar-days"></i></div>
<span class="cont">23 Dec 2023</span>
</div>
...
<div class="content">
<h3 class="mb-3">
<a class="black" href="/demo-10/blog-details">Fresh Breath Dental Studio
...
<div class="blog-items3">
<div class="thumb rounded-4 position-relative mb-3">
<img alt="img" class="rounded-4" src="/demo-10/assets/img/blog/blog3-v3.jpg"/>
<div class="d-flex gap-1 align-items-center blog-date">
<div class="icon d-center"><i class="fa-solid fa-calendar-days"></i></div>
<span class="cont">23 Dec 2023</span>
</div>
...
<h2 class="wow fadeInUp mb-xxl-4 mb-3 visible-slowly-right" data-wow-delay=".3s">
                  Ready to Restore Your Smile? Subscribe to Our Newsletter
                </h2>
<div class="btn-button">
<div class="appoinment-btn">
<a class="common-btn box-style first-box p1-bg d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold overflow-hidden rounded100 wow fadeInRight" data-wow-delay="0.8s" href="/demo-10/doctor-details">
                      Book An Appiontment
                      <img alt="icon" src="/demo-10/assets/img/icon/arrow-right-black.png"/>
</a>
</div>
...
<div class="thumb">
<img alt="thumb" src="/demo-10/assets/img/appiontment/appiontmentThumb3_3.png"/>
</div>
<div class="shape">
<img alt="icon" src="/demo-10/assets/img/appiontment/appiontmenticon3_1.png"/>
</div>
</div>
</div>
</div>
