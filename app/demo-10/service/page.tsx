...
<img alt="icon" src="/demo-10/assets/img/icon/ser1.png"/>
</div>
<h4 class="black"><a href="/demo-10/service-details">Quality Care Service</a></h4>
</div>
<p class="pra">
...
<img alt="img" class="rounded-4 overflow-hidden w-100" src="/demo-10/assets/img/service/service2-v4.jpg"/>
</div>
...
<div class="icon-area d-flex align-items-center gap-2">
<div class="icon d-center">
<img alt="icon" src="/demo-10/assets/img/icon/ser2.png"/>
</div>
<h4 class="black"><a href="/demo-10/service-details">Your Wellness Priority</a></h4>
</div>
<p class="pra">
                            Health care is a vital aspect maintaining overall well-being, encompassing a range
                        </p>
<div class="thumb overflow-hidden reveal-left position-relative">
<img alt="img" class="rounded-4 overflow-hidden w-100" src="/demo-10/assets/img/service/service2-v5.jpg"/>
</div>
<div class="text-center service-btn-inner">
<a class="common-btn box-style first-box d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold black overflow-hidden white-bg rounded100" href="/demo-10/service-details">
                                Read More
...
<div class="icon-area d-flex align-items-center gap-2">
<div class="icon d-center">
<img alt="icon" src="/demo-10/assets/img/icon/ser3.png"/>
</div>
<h4 class="black"><a href="/demo-10/service-details">Caring for You Always</a></h4>
</div>
<p class="pra">
                            Health care is a vital aspect maintaining overall well-being, encompassing a range
                        </p>
<div class="thumb overflow-hidden reveal-left position-relative">
<img alt="img" class="rounded-4 overflow-hidden w-100" src="/demo-10/assets/img/service/service2-v3.jpg"/>
</div>
<div class="text-center service-btn-inner">
<a class="common-btn box-style first-box d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold black overflow-hidden white-bg rounded100" href="/demo-10/service-details">
                                Read More
...
<div class="icon-area d-flex align-items-center gap-2">
<div class="icon d-center">
<img alt="icon" src="/demo-10/assets/img/icon/ser4.png"/>
</div>
<h4 class="black"><a href="/demo-10/service-details">Quality Care Service</a></h4>
</div>
<p class="pra">
...
<div class="thumb overflow-hidden reveal-left position-relative">
<img alt="img" class="rounded-4 overflow-hidden w-100" src="/demo-10/assets/img/service/service2-v6.jpg"/>
</div>
<div class="text-center service-btn-inner">
<a class="common-btn box-style first-box d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold black overflow-hidden white-bg rounded100" href="/demo-10/service-details">
                                Read More
...
<div class="icon-area d-flex align-items-center gap-2">
<div class="icon d-center">
<img alt="icon" src="/demo-10/assets/img/icon/ser5.png"/>
</div>
<h4 class="black"><a href="/demo-10/service-details">Where health meets</a></h4>
</div>
<p class="pra">
                            Health care is a vital aspect maintaining overall well-being, encompassing a range
                        </p>
<div class="thumb overflow-hidden reveal-left position-relative">
<img alt="img" class="rounded-4 overflow-hidden w-100" src="/demo-10/assets/img/service/service2-v1.jpg"/>
</div>
<div class="text-center service-btn-inner">
<a class="common-btn box-style first-box d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold black overflow-hidden white-bg rounded100" href="/demo-10/service-details">
                                Read More
...
<div class="icon-area d-flex align-items-center gap-2">
<div class="icon d-center">
<img alt="icon" src="/demo-10/assets/img/icon/ser6.png"/>
</div>
<h4 class="black"><a href="/demo-10/service-details">Center Harmony</a></h4>
</div>
<p class="pra">
                            Health care is a vital aspect maintaining overall well-being, encompassing a range
                        </p>
<div class="thumb overflow-hidden reveal-left position-relative">
<img alt="img" class="rounded-4 overflow-hidden w-100" src="/demo-10/assets/img/service/service2-v2.jpg"/>
</div>
<div class="text-center service-btn-inner">
<a class="common-btn box-style first-box d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold black overflow-hidden white-bg rounded100" href="/demo-10/service-details">
                                Read More
