...
<h2 class="tpbreadcrumb-title">Register Now</h2>
...
<!-- breadcrumb-area-end -->
<!-- login area start -->
<section class="tp-login-area pb-140 p-relative z-index-1 fix pt-145">
...
<h3 class="tp-login-title">Sign Up Vamary.</h3>
<p>Already have an account?  <span><a href="/demo-12/login">Sign In</a></span></p>
</div>
...
<a href="#">
<img alt="" src="/demo-12/assets/img/icon/login/google.html"/>
                                    Sign up with google
                                 </a>
</div>
<div class="tp-login-option-item">
<a href="#">
<img alt="" src="/demo-12/assets/img/icon/login/facebook.html"/>
</a>
</div>
<div class="tp-login-option-item">
<a href="#">
<img alt="" class="apple" src="/demo-12/assets/img/icon/login/apple.html"/>
</a>
</div>
</div>
...
<input id="name" placeholder="Matiour Rahman" type="text"/>
</div>
...
<div class="tp-login-input-box">
<div class="tp-login-input">
<input id="tp_password" placeholder="Min. 6 character" type="password"/>
</div>
<div class="tp-login-input-eye" id="password-show-toggle">
<span class="open-eye" id="open-eye">
<svg fill="none" height="14" viewbox="0 0 18 14" width="18" xmlns="http://www.w3.org/2000/svg">
<path d="M1 6.77778C1 6.77778 3.90909 1 9 1C14.0909 1 17 6.77778 17 6.77778C17 6.77778 14.0909 12.5556 9 12.5556C3.90909 12.5556 1 6.77778 1 6.77778Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.2"></path>
<path d="M9.00018 8.94466C10.2052 8.94466 11.182 7.97461 11.182 6.77799C11.182 5.58138 10.2052 4.61133 9.00018 4.61133C7.79519 4.61133 6.81836 5.58138 6.81836 6.77799C6.81836 7.97461 7.79519 8.94466 9.00018 8.94466Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.2"></path>
</svg>
</span>
<span class="open-close" id="close-eye">
...
<a class="tp-login-btn w-100" href="#">Sign Up</a>
</div>
</div>
</div>
</div>
