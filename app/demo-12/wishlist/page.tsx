...
<h2 class="tpbreadcrumb-title">Wishlist</h2>
...
<!-- breadcrumb-area-end -->
<!-- cart area start -->
<div class="tp-cart-area pt-145 pb-145">
<div class="container">
<div class="row">
<div class="col-xl-12">
...
<button class="tp-btn" type="submit">Add To Cart</button>
</td>
<!-- action -->
...
<!-- title -->
<td class="tp-cart-title"><a href="/demo-12/shop-details">Rapid Response Masque</a></td>
<!-- price -->
...
<tr>
<!-- img -->
<td class="tp-cart-img"><a href="/demo-12/shop-details"> <img alt="" src="/demo-12/assets/img/product/product-5.html"/></a></td>
<!-- title -->
<td class="tp-cart-title"><a href="/demo-12/shop-details">Glow Screen Sunscreen</a></td>
<!-- price -->
...
<a class="tp-cart-update-btn" href="#">Go To Cart</a>
</div>
</div>
</div>
</div>
