...
export default function Page() {
  ...
  return (
    <div className="boxed_wrapper">
                        ...
                        <div className="image-box">
                            <div className="row clearfix">
                                <div className="col-lg-6 col-md-6 col-sm-12 column">
                                    <figure className="image mb-30"><img src="/demo-13/assets/images/resource/about-3.jpg" alt="" /></figure>
                                    <figure className="image"><img src="/demo-13/assets/images/resource/about-4.jpg" alt="" /></figure>
                                </div>
                                <div className="col-lg-6 col-md-6 col-sm-12 column">
                                    <figure className="image"><img src="/demo-13/assets/images/resource/about-5.jpg" alt="" /></figure>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section className="startup-section alternat-2" style={{ backgroundImage: "url(/demo-13/assets/images/background/startup-1.jpg)" }}>
            <div className="auto-container">
        ...
        <section className="team-section">
            <div className="auto-container">
                ...
                <div className="team-inner clearfix mb-0">
        ...
        <section className="testimonial-section alternat-2 sec-pad centred border-bottom">
            <div className="auto-container">
                <div className="sec-title">
