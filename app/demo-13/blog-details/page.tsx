...
export default function Page() {
  ...
  return (
    <div className="boxed_wrapper">
        ...
        <section className="blog-details sidebar-page-container sec-pad-2">
            <div className="auto-container">
                <div className="row clearfix">
                        ...
                        <div className="blog-details-content">
                            <div className="news-block-one">
                                <div className="inner-box">
                                    <figure className="image-box">
                                        <img src="/demo-13/assets/images/news/news-7.jpg" alt="" />
                                    ...
                                    <div className="lower-content">
                                        ...
                                        <h2>How you can choose the best physiotherapy clinic</h2>
                            ...
                            <div className="post-share-option clearfix">
                                ...
                                <ul className="social-links pull-right">
                                    <li><a href="/demo-13/blog-details"><i className="fab fa-twitter"></i></a></li>
                                    <li><a href="/demo-13/blog-details"><i className="fab fa-facebook-square"></i></a></li>
                                    <li><a href="/demo-13/blog-details"><i className="fab fa-pinterest-p"></i></a></li>
                                    <li><a href="/demo-13/blog-details"><i className="fab fa-instagram"></i></a></li>
                                </ul>
                            </div>
                            <div className="author-box">
                                <div className="inner">
                                    <figure className="author-thumb"><img src="/demo-13/assets/images/news/author-1.jpg" alt="" /></figure>
                                    <h4>Christine Eve</h4>
                                ...
                                <div className="comment-box">
                                    <div className="comment">
                                        <figure className="thumb-box">
                                            <img src="/demo-13/assets/images/news/comment-1.png" alt="" />
                                        </figure>
                                        <div className="comment-inner">
                                            <h4>Kevin Martin <span>20 June, 2020</span></h4>
                                            <p>Lorem ipsum is simply free text used by copytyping refreshing. Neque porro est qui dolorem ipsum quia quaed inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                            <a href="/demo-13/blog-details">reply</a>
                                        </div>
                                    </div>
                                    <div className="comment">
                                        <figure className="thumb-box">
                                            <img src="/demo-13/assets/images/news/comment-2.png" alt="" />
                                        </figure>
                                        <div className="comment-inner">
                                            <h4>Sarah Albert <span>19 June, 2020</span></h4>
                                            <p>Lorem ipsum is simply free text used by copytyping refreshing. Neque porro est qui dolorem ipsum quia quaed inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo.</p>
                                            <a href="/demo-13/blog-details">reply</a>
                                        </div>
                                    </div>
                            ...
                            <div className="comments-form-area">
                                ...
                                <form action="https://azim.commonsupport.com/Resox/blog-details.html" method="post" className="comment-form default-form">
                                    <div className="row clearfix">
                                        ...
                                        <div className="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                                            <button type="submit" className="theme-btn-one">Submit Comment</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
