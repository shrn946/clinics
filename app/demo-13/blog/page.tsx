...
export default function Page() {
  ...
  return (
    <div className="boxed_wrapper">
        ...
        <section className="blog-grid sec-pad-2">
            <div className="auto-container">
                <div className="row clearfix">
                        ...
                        <div className="news-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div className="inner-box">
                                <figure className="image-box">
                                    ...
                                    <span className="post-date">22 June, 2020</span>
                                </figure>
                                <div className="lower-content">
                                    <ul className="post-info clearfix">
                                        <li><i className="far fa-user-circle"></i><a href="/demo-13/index2">Admin</a></li>
                        ...
                        <div className="news-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div className="inner-box">
                                <figure className="image-box">
                                    ...
                                    <span className="post-date">21 June, 2020</span>
                                </figure>
                                <div className="lower-content">
                                    <ul className="post-info clearfix">
                                        <li><i className="far fa-user-circle"></i><a href="/demo-13/index2">Admin</a></li>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div className="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                            <div className="inner-box">
                                <figure className="image-box">
                                    <a href="/demo-13/blog-details"><img src="/demo-13/assets/images/news/news-4.jpg" alt="" /></a>
                                ...
                                <div className="lower-content">
                                    ...
                                    <h3><a href="/demo-13/blog-details">The right diet for your body history of chiropr- actic care</a></h3>
                                    <p>Lorem ipsum is simply free text used by new pesnhl note this copytyping refreshing.</p>
                                    <div className="link"><a href="/demo-13/blog-details"><i className="fas fa-chevron-circle-right"></i>Read More</a></div>
                                </div>
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div className="news-block-one wow fadeInUp animated animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div className="inner-box">
                                <figure className="image-box">
                                    <a href="/demo-13/blog-details"><img src="/demo-13/assets/images/news/news-5.jpg" alt="" /></a>
                                ...
                                <div className="lower-content">
                                    ...
                                    <h3><a href="/demo-13/blog-details">Learn history of chiropr- actic care remove your pain</a></h3>
                                    <p>Lorem ipsum is simply free text used by new pesnhl note this copytyping refreshing.</p>
                                    <div className="link"><a href="/demo-13/blog-details"><i className="fas fa-chevron-circle-right"></i>Read More</a></div>
                                </div>
                            </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 news-block">
                        <div className="news-block-one wow fadeInUp animated animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div className="inner-box">
                                <figure className="image-box">
                                    <a href="/demo-13/blog-details"><img src="/demo-13/assets/images/news/news-6.jpg" alt="" /></a>
                                ...
                                <div className="lower-content">
                                    ...
                                    <h3><a href="/demo-13/blog-details">We can recover your body injury pain by exercise</a></h3>
                                    <p>Lorem ipsum is simply free text used by new pesnhl note this copytyping refreshing.</p>
                                    <div className="link"><a href="/demo-13/blog-details"><i className="fas fa-chevron-circle-right"></i>Read More</a></div>
                                </div>
                            </div>
