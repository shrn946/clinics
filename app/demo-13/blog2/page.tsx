...
export default function Page() {
  ...
  return (
    <div className="boxed_wrapper">
                            ...
                            <nav className="main-menu navbar-expand-md navbar-light pull-left">
                                <div className="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul className="navigation clearfix">
                                        ...
                                        <li className="current dropdown"><a href="/demo-13/index2">Blog</a>
                                            <ul>
        ...
        <section className="blog-standard sidebar-page-container sec-pad-2">
            <div className="auto-container">
                <div className="row clearfix">
                    <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                        <div className="blog-standard-content">
                            <div className="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div className="inner-box">
                                    <figure className="image-box">
                                        <a href="/demo-13/blog-details"><img src="/demo-13/assets/images/news/news-7.jpg" alt="" /></a>
                                        <span className="post-date">23 June, 2020</span>
                                    </figure>
                                    <div className="lower-content">
                                        ...
                                        <h2><a href="/demo-13/blog-details">How you can choose the best physiotherapy clinic</a></h2>
                                        <p>Lorem ipsum is simply free text used by new pesnhl note this copytyping refreshing. Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et</p>
                            ...
                            <div className="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div className="inner-box">
                                    <figure className="image-box">
                                        <a href="/demo-13/blog-details"><img src="/demo-13/assets/images/news/news-8.jpg" alt="" /></a>
                                        <span className="post-date">25 June, 2020</span>
                                    </figure>
                                    <div className="lower-content">
                                        <ul className="post-info clearfix">
                                            <li><i className="far fa-user-circle"></i><a href="/demo-13/index2">Admin</a></li>
                                            <li><i className="far fa-comments"></i><a href="/demo-13/index2">6 Comments</a></li>
                                        </ul>
                                        <h2><a href="/demo-13/blog-details">Eat the right diet for your body to stay healthy</a></h2>
                                        <p>Lorem ipsum is simply free text used by new pesnhl note this copytyping refreshing. Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et</p>
                                        <div className="link"><a href="/demo-13/blog-details"><i className="fas fa-chevron-circle-right"></i>Read More</a></div>
                                    </div>
                                </div>
                            ...
                            <div className="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div className="inner-box">
                                    <figure className="image-box">
                                        <a href="/demo-13/blog-details"><img src="/demo-13/assets/images/news/news-9.jpg" alt="" /></a>
                                        <span className="post-date">26 June, 2020</span>
                                    </figure>
                                    <div className="lower-content">
                                        <ul className="post-info clearfix">
                                            <li><i className="far fa-user-circle"></i><a href="/demo-13/index2">Admin</a></li>
                                            <li><i className="far fa-comments"></i><a href="/demo-13/index2">2 Comments</a></li>
                                        </ul>
                                        <h2><a href="/demo-13/blog-details">How can chiropractic care help your health system</a></h2>
                                        <p>Lorem ipsum is simply free text used by new pesnhl note this copytyping refreshing. Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et</p>
                                        <div className="link"><a href="/demo-13/blog-details"><i className="fas fa-chevron-circle-right"></i>Read More</a></div>
                                    </div>
                                </div>
                            ...
                            <div className="news-block-one wow fadeInUp animated animated" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div className="inner-box">
                                    <figure className="image-box">
                                        <a href="/demo-13/blog-details"><img src="/demo-13/assets/images/news/news-10.jpg" alt="" /></a>
                                        <span className="post-date">23 June, 2020</span>
                                    </figure>
                                    <div className="lower-content">
                                        <ul className="post-info clearfix">
                                        ...
                                        <h2><a href="/demo-13/blog-details">We can recover your body injury pain by exercise</a></h2>
                                        <p>Lorem ipsum is simply free text used by new pesnhl note this copytyping refreshing. Consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et</p>
                                        <div className="link"><a href="/demo-13/blog-details"><i className="fas fa-chevron-circle-right"></i>Read More</a></div>
                                    </div>
                                </div>
                            ...
                            <div className="pagination-wrapper">
                                <ul className="pagination">
                                    <li><a href="/demo-13/blog"><i className="far fa-angle-left"></i></a></li>
                                    <li><a href="/demo-13/blog" className="active">01</a></li>
                                    <li><a href="/demo-13/blog">02</a></li>
                                    <li><a href="/demo-13/blog">03</a></li>
                                    <li><a href="/demo-13/blog"><i className="far fa-angle-right"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                        <div className="sidebar">
                            <div className="search-widget">
                                <form action="https://azim.commonsupport.com/Resox/blog-details.html" method="post" className="search-form">
                            ...
                            <div className="sidebar-widget post-widget">
                                ...
                                <div className="post-inner">
                                    <div className="post">
                                        <figure className="post-thumb"><a href="/demo-13/blog-details"><img src="/demo-13/assets/images/news/post-1.jpg" alt="" /></a></figure>
                                        <span className="post-date">June 16, 2020</span>
                                        <h5><a href="/demo-13/blog-details">Learn history of chiropractic care</a></h5>
                                    </div>
                                    <div className="post">
                                        <figure className="post-thumb"><a href="/demo-13/blog-details"><img src="/demo-13/assets/images/news/post-2.jpg" alt="" /></a></figure>
                                        <span className="post-date">June 15, 2020</span>
                                        <h5><a href="/demo-13/blog-details">How can we remove your pain</a></h5>
                                    </div>
                                    <div className="post">
                                        <figure className="post-thumb"><a href="/demo-13/blog-details"><img src="/demo-13/assets/images/news/post-3.jpg" alt="" /></a></figure>
                                        <span className="post-date">June 14, 2020</span>
                                        <h5><a href="/demo-13/blog-details">How can we remove your pain</a></h5>
                                    </div>
                                </div>
                            </div>
                            <div className="sidebar-widget categories-widget">
                                ...
                                <ul className="categories-list clearfix">
                                    <li><a href="/demo-13/blog-details">Injuries<span>09</span></a></li>
                                    <li><a href="/demo-13/blog-details">Treatments<span>16</span></a></li>
                                    <li><a href="/demo-13/blog-details">Physiotherapy<span>23</span></a></li>
                                    <li><a href="/demo-13/blog-details">Massage Therapy<span>04</span></a></li>
                                    <li><a href="/demo-13/blog-details">Chiropratic<span>07</span></a></li>
                                </ul>
                            </div>
                            <div className="sidebar-widget tags-widget">
                                ...
                                <ul className="tags-list clearfix">
                                    <li><a href="/demo-13/blog-details">injuries,</a></li>
                                    <li><a href="/demo-13/blog-details">treatments,</a></li>
                                    <li><a href="/demo-13/blog-details">physiotherapy,</a></li>
                                    <li><a href="/demo-13/blog-details">massage therapy,</a></li>
                                    <li><a href="/demo-13/blog-details">chiropratic,</a></li>
                                    <li><a href="/demo-13/blog-details">body pain,</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
