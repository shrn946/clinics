...
export default function Page() {
  ...
  return (
    <div className="boxed_wrapper">
                            ...
                            <nav className="main-menu navbar-expand-md navbar-light pull-left">
                                <div className="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul className="navigation clearfix">
                                        ...
                                        <li className="current"><a href="/demo-13/contact">Contact</a></li>   
                                    </ul>
                                </div>
                            </nav>
            ...
            <div className="auto-container">
                ...
                <div className="row clearfix">
                    <div className="col-lg-4 col-md-6 col-sm-12 info-column">
                        <div className="info-inner" style={{ backgroundImage: "url(/demo-13/assets/images/resource/info-1.jpg)" }}>
                            <div className="content-box">
                                <div className="text">
                                ...
                                <ul className="info-list clearfix">
                                    ...
                                    <li>
                                        <i className="flaticon-pin"></i>
                                         88 broklyn silver street, New York. USA
                                    </li>
                                </ul>
                    ...
                    <div className="col-lg-8 col-md-6 col-sm-12 form-column">
                        <div className="form-inner">
                            <form method="post" action="https://azim.commonsupport.com/Resox/sendemail.php" id="contact-form" className="default-form"> 
                                <div className="row clearfix">
                                    ...
                                    <div className="col-lg-12 col-md-12 col-sm-12 form-group message-btn">
                                        <button className="theme-btn-one" type="submit" name="submit-form">Submit Now</button>
                                    </div>
                                </div>
                            </form>
                        </div>
        ...
        <section className="google-map-section style-two">
            <div className="auto-container">
