...
export default function Page() {
  ...
  return (
    <div className="boxed_wrapper">
                            ...
                            <nav className="main-menu navbar-expand-md navbar-light pull-left">
                                <div className="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                    <ul className="navigation clearfix">
                                        ...
                                        <li className="current dropdown"><a href="/demo-13/index2">Pages</a>
                                            <ul>
            ...
            <div className="auto-container">
                <div className="row clearfix">
                    <div className="col-lg-6 col-md-12 col-sm-12 image-column">
                        <figure className="image-box"><img src="/demo-13/assets/images/team/team-details-1.jpg" alt="" /></figure>
                    </div>
                    <div className="col-lg-6 col-md-12 col-sm-12 content-column">
                        <div className="team-details-content ml-70">
                            <div className="upper-box">
                                <h2>Dr. Kevin Martin</h2>
                                <span className="designation">Senior Therapist</span>
                                <ul className="social-links clearfix">
                                    <li><a href="/demo-13/doctor-details"><i className="fab fa-twitter"></i></a></li>
                                    <li><a href="/demo-13/doctor-details"><i className="fab fa-facebook-square"></i></a></li>
                                    <li><a href="/demo-13/doctor-details"><i className="fab fa-instagram"></i></a></li>
                                    <li><a href="/demo-13/doctor-details"><i className="fab fa-pinterest-p"></i></a></li>
                                </ul>
                            </div>
                            <div className="text">
                                <p>Lorem ipsum dolor sit amet, con elit tiam convallis elit id impedie. Quisq simply free ornare tortor. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                            </div>
                            <div className="progress-inner">
                                ...
                                <div className="progress-box">
                                    <h5>Chiropratic</h5>
                                    <div className="bar">
                                        <div className="bar-inner count-bar" data-percent="66%"></div>
                                        <div className="count-text">66%</div>
                                    </div>
                                </div>
                                <div className="progress-box">
                                    <h5>Massage</h5>
                                    <div className="bar">
                                        <div className="bar-inner count-bar" data-percent="43%"></div>
                                        <div className="count-text">43%</div>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <section className="certificates-section bg-color-4">
            <div className="auto-container">
                <div className="row clearfix">
                    ...
                    <div className="col-lg-8 col-md-12 col-sm-12 certificates-column">
                        <div className="certificates-inner ml-50">
                            <div className="row clearfix">
                                <div className="col-lg-4 col-md-6 col-sm-12 image-column">
                                    <figure className="image-box"><img src="/demo-13/assets/images/resource/certificates-1.jpg" alt="" /></figure>
                                </div>
                                <div className="col-lg-4 col-md-6 col-sm-12 image-column">
                                    <figure className="image-box"><img src="/demo-13/assets/images/resource/certificates-2.jpg" alt="" /></figure>
                                </div>
                                <div className="col-lg-4 col-md-6 col-sm-12 image-column">
                                    <figure className="image-box"><img src="/demo-13/assets/images/resource/certificates-3.jpg" alt="" /></figure>
                                </div>
                            </div>
                        </div>
                    </div>
