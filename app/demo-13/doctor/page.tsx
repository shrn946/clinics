                ...
                <div className="row clearfix">
                        ...
                        <div className="team-block-one">
                            <div className="inner-box">
                                <figure className="image-box">
                                    <img src="/demo-13/assets/images/team/team-5.jpg" alt="" />
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div className="team-block-one">
                            <div className="inner-box">
                                <figure className="image-box">
                                    <img src="/demo-13/assets/images/team/team-6.jpg" alt="" />
                                    <ul className="social-links clearfix">
                                        <li><a href="/demo-13/index3"><i className="fab fa-twitter"></i></a></li>
                                        <li><a href="/demo-13/index3"><i className="fab fa-facebook-square"></i></a></li>
                                        <li><a href="/demo-13/index3"><i className="fab fa-instagram"></i></a></li>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div className="team-block-one">
                            <div className="inner-box">
                                <figure className="image-box">
                                    <img src="/demo-13/assets/images/team/team-7.jpg" alt="" />
                                    <ul className="social-links clearfix">
                                        <li><a href="/demo-13/index3"><i className="fab fa-twitter"></i></a></li>
                                        <li><a href="/demo-13/index3"><i className="fab fa-facebook-square"></i></a></li>
                                        <li><a href="/demo-13/index3"><i className="fab fa-instagram"></i></a></li>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div className="team-block-one">
                            <div className="inner-box">
                                <figure className="image-box">
                                    <img src="/demo-13/assets/images/team/team-8.jpg" alt="" />
                                    <ul className="social-links clearfix">
                                        <li><a href="/demo-13/index3"><i className="fab fa-twitter"></i></a></li>
                                        <li><a href="/demo-13/index3"><i className="fab fa-facebook-square"></i></a></li>
                                        <li><a href="/demo-13/index3"><i className="fab fa-instagram"></i></a></li>
                                ...
                                <div className="lower-content">
                                    <h5><a href="/demo-13/doctor-details">Mike Hardson</a></h5>
                                    <span className="designation">Therapist</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div className="team-block-one">
                            <div className="inner-box">
                                <figure className="image-box">
                                    <img src="/demo-13/assets/images/team/team-9.jpg" alt="" />
                                    <ul className="social-links clearfix">
                                        <li><a href="/demo-13/index3"><i className="fab fa-twitter"></i></a></li>
                                        <li><a href="/demo-13/index3"><i className="fab fa-facebook-square"></i></a></li>
                                        <li><a href="/demo-13/index3"><i className="fab fa-instagram"></i></a></li>
                                ...
                                <div className="lower-content">
                                    <h5><a href="/demo-13/doctor-details">Christine Eve</a></h5>
                                    <span className="designation">Therapist</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div className="team-block-one">
                            <div className="inner-box">
                                <figure className="image-box">
                                    <img src="/demo-13/assets/images/team/team-10.jpg" alt="" />
                                    <ul className="social-links clearfix">
                                        <li><a href="/demo-13/index3"><i className="fab fa-twitter"></i></a></li>
                                        <li><a href="/demo-13/index3"><i className="fab fa-facebook-square"></i></a></li>
                                        <li><a href="/demo-13/index3"><i className="fab fa-instagram"></i></a></li>
                                ...
                                <div className="lower-content">
                                    <h5><a href="/demo-13/doctor-details">John Smith</a></h5>
                                    <span className="designation">Therapist</span>
                                </div>
                            </div>
                        </div>
