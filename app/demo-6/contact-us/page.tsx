...
export default function Page() {
  return (
    <div className="wp-singular page-template page-template-theme_header_footer page page-id-157 wp-embed-responsive -hello-theme hello-theme-default theme-default theme-template-full-width theme-kit-7 theme-page theme-page-157">
...
<div class="theme theme-157" data-theme-id="157" data-theme-post-type="page" data-theme-type="wp-page">
