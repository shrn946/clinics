...
export default function Page() {
  return (
    <div className="page-template page-template-theme_header_footer page page-id-143 -responsive -hello-theme hello-theme-default theme-default theme-template-full-width theme-kit-7 theme-page theme-page-143">
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-143 current_page_item menu-item-233"><a aria-current="page" class="theme-sub-item theme-item-active" href="index.html">Pricing Plan 02</a></li>
...
<li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-143 current_page_item menu-item-233"><a aria-current="page" class="theme-sub-item theme-item-active" href="index.html" tabindex="-1">Pricing Plan 02</a></li>
...
<div class="theme theme-143" data-theme-id="143" data-theme-post-type="page" data-theme-type="">
...
<div class="theme-widget-container">
<div "="" class="pt_plus_breadcrumbs_bar" id="bread6a41e48994272"><div class="pt_plus_breadcrumbs_bar_inner bred_style_1"><nav id="breadcrumbs"><span class="bc_home"><a class="home_bread_tab" href="../index.html"><i class="fa fa-bank bread-home-icon"></i>Home</a></span> <span class="del"></span> <span class="current on-off-current"><div class="current_tab_sec">Pricing Plan 02</div></span></nav></div></div> </div>
</div>
</div>
</div>
</div>
