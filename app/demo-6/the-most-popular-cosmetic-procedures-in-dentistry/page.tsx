...
export default function Page() {
  return (
    <div className="wp-singular post-template-default single single-post postid-212 single-format-standard wp-embed-responsive -hello-theme hello-theme-default theme-default theme-kit-7 theme-page-25">
...
<div class="theme theme-25 theme-location-single post-212 post type-post status-publish format-standard has-post-thumbnail hentry category-uncategorized" data-theme-id="25" data-theme-post-type="theme_library" data-theme-type="single-post">
<div class="theme-element theme-element-64f3fdfa e-flex e-con-boxed e-con e-parent" data-e-type="container" data-element_type="container" data-id="64f3fdfa" data-settings='{"background_background":"gradient"}'>
<div class="e-con-inner">
<div class="theme-element theme-element-2698c629 e-con-full e-flex e-con e-child" data-e-type="container" data-element_type="container" data-id="2698c629" data-settings='{"background_background":"classic"}'>
<div class="theme-element theme-element-98575c6 theme-widget__width-inherit theme-invisible theme-widget theme-widget-heading" data-e-type="widget" data-element_type="widget" data-id="98575c6" data-settings='{"_animation":"fadeIn"}' data-widget_type="heading.default">
<div class="theme-widget-container">
<div class="theme-heading-title theme-size-default">Our blog</div> </div>
</div>
<div class="theme-element theme-element-2a4701c theme-widget theme-widget-tp-post-title" data-e-type="widget" data-element_type="widget" data-id="2a4701c" data-widget_type="tp-post-title.default">
<div class="theme-widget-container">
<div class="tp-post-title"><h1 class="tp-entry-title">The most popular cosmetic procedures in dentistry</h1></div> </div>
</div>
...
<div class="theme-element theme-element-2ed27087 e-flex e-con-boxed e-con e-parent" data-e-type="container" data-element_type="container" data-id="2ed27087">
<div class="e-con-inner">
...
<div class="theme-widget-container">
<div class="tp-post-image"><div class="tp-featured-image"><a href="/demo-6"><img alt="" class="tp-featured-img" decoding="async" fetchpriority="high" height="1000" sizes="(max-width: 1500px) 100vw, 1500px" src="/demo-6/assets/uploads/sites/19/2024/09/smiling-dentists-interacting-with-young-patient-2021-08-28-16-45-12-utc-min.jpg" srcset="/demo-6/assets/uploads/sites/19/2024/09/smiling-dentists-interacting-with-young-patient-2021-08-28-16-45-12-utc-min.jpg 1500w, /demo-6/assets/uploads/sites/19/2024/09/smiling-dentists-interacting-with-young-patient-2021-08-28-16-45-12-utc-min-300x200.jpg 300w, /demo-6/assets/uploads/sites/19/2024/09/smiling-dentists-interacting-with-young-patient-2021-08-28-16-45-12-utc-min-1024x683.jpg 1024w, /demo-6/assets/uploads/sites/19/2024/09/smiling-dentists-interacting-with-young-patient-2021-08-28-16-45-12-utc-min-768x512.jpg 768w" width="1500"/></a></div></div> </div>
</div>
...
<div class="theme-widget-container">
<div class="tp-post-content tp-"><p>Mi sit amet mauris commodo quis imperdiet massa. Faucibus scelerisque eleifend donec pretium vulputate sapien. Pharetra massa massa ultricies mi quis hendrerit dolor magna. Eget nunc lobortis mattis aliquam faucibus. Cursus vitae congue mauris rhoncus aenean. Augue neque gravida in fermentum et.</p>
<p>Quam nulla porttitor massa id neque aliquam vestibulum morbi. Nec ultrices dui sapien eget. Lacus viverra vitae congue eu consequat ac felis. Est velit egestas dui id ornare arcu. Tellus id interdum velit laoreet id donec ultrices tincidunt arcu. Scelerisque varius morbi enim nunc. Scelerisque mauris pellentesque pulvinar pellentesque habitant. Porttitor massa id neque aliquam. At quis risus sed vulputate odio ut enim blandit. Amet purus gravida quis blandit turpis cursus. Commodo nulla facilisi nullam vehicula ipsum a arcu cursus vitae. Cursus metus aliquam eleifend mi in nulla posuere sollicitudin aliquam. Gravida arcu ac tortor dignissim convallis. Feugiat scelerisque varius morbi enim nunc faucibus a.</p>
<p>Metus vulputate eu scelerisque felis. Elementum pulvinar etiam non quam lacus suspendisse faucibus interdum. Maecenas sed enim ut sem viverra aliquet eget sit. Hac habitasse platea dictumst quisque sagittis purus sit amet. Eget sit amet tellus cras adipiscing enim eu turpis. Dolor purus non enim praesent elementum facilisis leo vel. Et magnis dis parturient montes. Accumsan in nisl nisi scelerisque eu ultrices vitae. Tortor posuere ac ut consequat semper. Eu nisl nunc mi ipsum faucibus vitae aliquet nec. Etiam dignissim diam quis enim lobortis scelerisque fermentum dui faucibus. Metus vulputate eu scelerisque felis imperdiet proin. Curabitur gravida arcu ac tortor dignissim convallis aenean et. Sagittis purus sit amet volutpat consequat mauris. Et ligula ullamcorper malesuada proin libero. Et malesuada fames ac turpis egestas integer eget aliquet. Facilisi nullam vehicula ipsum a arcu cursus.</p>
<p>Amet mauris commodo quis imperdiet massa tincidunt. Potenti nullam ac tortor vitae purus faucibus. Proin fermentum leo vel orci porta non pulvinar neque laoreet. Blandit massa enim nec dui. Viverra nam libero justo laoreet sit. Ut pharetra sit amet aliquam id. Etiam sit amet nisl purus in mollis nunc sed. Eget nunc scelerisque viverra mauris in. Vitae suscipit tellus mauris a diam maecenas sed enim. Elit ullamcorper dignissim cras tincidunt lobortis feugiat vivamus at. Amet consectetur adipiscing elit ut aliquam purus sit amet. Laoreet id donec ultrices tincidunt arcu non. Fermentum et sollicitudin ac orci phasellus egestas. Auctor elit sed vulputate mi sit amet mauris commodo. Lorem dolor sed viverra ipsum nunc aliquet bibendum enim facilisis. Nisl nisi scelerisque eu ultrices vitae auctor eu augue ut. Ac placerat vestibulum lectus mauris ultrices.</p>
</div> </div>
</div>
<div class="theme-element theme-element-cd8c85c theme-widget theme-widget-tp-post-comment" data-e-type="widget" data-element_type="widget" data-id="cd8c85c" data-widget_type="tp-post-comment.default">
<div class="theme-widget-container">
<div class="tp-post-comment tp-widget-tp-comment6a41e52e01d23"><div class="comments-area" id="comments"> <div class="comment-respond" id="respond">
<h3 class="comment-reply-title" id="reply-title">Leave Your Comment <small><a href="index.html#respond" id="cancel-comment-reply-link" rel="nofollow" style="display:none;">Cancel Reply</a></small></h3><form action="https://templateup.site/dental/wp-comments-post.php" class="comment-form" id="commentform" method="post"><div class="tp-row"><div class="tp-col-md-12 tp-col"><label><textarea aria-required="true" cols="45" id="comment" name="comment" placeholder="Comment" rows="6"></textarea></label></div></div><p class="comment-form-author"><label for="author">Name <span class="required">*</span></label> <input autocomplete="name" id="author" maxlength="245" name="author" required="" size="30" type="text" value=""/></p>
<p class="comment-form-email"><label for="email">Email <span class="required">*</span></label> <input autocomplete="email" id="email" maxlength="100" name="email" required="" size="30" type="email" value=""/></p>
<p class="comment-form-url"><label for="url">Website</label> <input autocomplete="url" id="url" maxlength="200" name="url" size="30" type="url" value=""/></p>
<p class="comment-form-cookies-consent"><input id="wp-comment-cookies-consent" name="wp-comment-cookies-consent" type="checkbox" value="yes"/> <label for="wp-comment-cookies-consent">Save my name, email, and website in this browser for the next time I comment.</label></p>
<p class="form-submit"><input class="submit" id="submit" name="submit" type="submit" value="Submit Now"/> <input id="comment_post_ID" name="comment_post_ID" type="hidden" value="212"/>
