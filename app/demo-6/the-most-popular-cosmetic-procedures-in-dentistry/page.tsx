...
<p class="comment-form-cookies-consent"><input id="-cookies-consent" name="-cookies-consent" type="checkbox" value="yes"/> <label for="-cookies-consent">Save my name, email, and website in this browser for the next time I comment.</label></p>
