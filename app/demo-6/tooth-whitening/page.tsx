...
export default function Page() {
  return (
    <div className="page-template page-template-theme_header_footer page page-id-147 -responsive -hello-theme hello-theme-default theme-default theme-template-full-width theme-kit-7 theme-page theme-page-147">
...
<div class="theme theme-147" data-theme-id="147" data-theme-post-type="page" data-theme-type="">
