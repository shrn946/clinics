...
<h1 class="text-white split-title">Register</h1>
</div>
...
<!-- Login Sction Start -->
<section class="login-section section-padding fix">
<div class="container">
...
<span class="lable-text">Username*</span>
<input id="name" name="name" placeholder="Your Name" type="text"/>
</div>
<div class="input-item">
<span class="lable-text">Email Address</span>
<input id="email1" placeholder="info@example.com" type="email"/>
</div>
<div class="input-item">
<span class="lable-text">Password</span>
<input id="password" placeholder="Password" type="password"/>
</div>
<div class="input-item">
<span class="lable-text">Confirm Password*</span>
<input id="password2" placeholder="Enter Your Password" type="password"/>
</div>
...
<!-- Brand Section Start -->
<div class="brand-section-one section-padding pt-0">
<div class="container">
