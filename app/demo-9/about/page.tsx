...
<h4><a class="black fw_600" href="/demo-9/doctor">Quality Care <br/> Exceptional Service</a>
</h4>
</div>
...
<a class="common-btn cmn-border text-nowrap d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold black overflow-hidden rounded100 wow fadeInRight" data-wow-delay="0.8s" href="/demo-9/doctor">
                            Read More
...
<h4><a class="black fw_600" href="/demo-9/doctor">Healing Lives One <br/> Patient at a
                                        Time</a></h4>
</div>
<ul class="feature-list d-flex flex-column gap-1">
<li>
...
<h4><a class="black fw_600" href="/demo-9/doctor">Caring for You Caring <br/> for
                                        Tomorrow</a></h4>
</div>
<ul class="feature-list d-flex flex-column gap-1">
<li>
...
<!-- Element-->
<a class="feature-element" href="/demo-9/doctor">
...
<a class="w-100 rounded-4 overflow-hidden" href="/demo-9/doctor-details">
...
<a class="w-100 rounded-4 overflow-hidden mb-xxl-4 mb-3 d-block" href="/demo-9/doctor-details">
<img alt="img" class="rounded-4 w-100" src="/demo-9/assets/img/choose/choose2.jpg"/>
</a>
<h4 class="mb-xxl-3 mb-2">
<a class="black fw_700" href="/demo-9/doctor-details">
...
<a class="video-choose d-center rounded-circle p1-bg video-popup" href="/demo-9/doctor-details">
...
<a class="special-tag d-flex align-items-center gap-3 gap-2 rounded-3 heading-font cmn-border" href="/demo-9/project">
<img alt="icon" src="/demo-9/assets/img/icon/arrow-right-black.png"/>
...
<a class="common-btn arrow-white-adding box-style white-border d-inline-flex justify-content-center align-items-center gap-xxl-2 gap-2 fs18 fw-semibold py-3 white overflow-hidden rounded100 wow fadeInRight" data-wow-delay="0.8s" href="/demo-9/project">
                                        Read More
