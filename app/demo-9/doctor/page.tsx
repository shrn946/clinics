...
<!-- Extra Hover -->
<img alt="img" class="extra-feature" src="/demo-9/assets/img/choose/feature5.jpg"/>
</div>
<div class="line"></div>
</div>
<div class="ins d-flex flex-column gap-xxl-4 gap-3">
...
<div class="feature-items">
<div class="feature-left d-lg-flex d-grid gap-3 flex-lg-nowrap flex-wrap justify-content-between align-items-center">
<h4><a class="black fw_600 text-nowrap" href="/demo-9/doctor-details">Dr.Nikol Jons</a>
</h4>
<ul class="feature-list d-flex flex-column gap-1">
<li class="text-nowrap">
                                        Heart Spacialist
...
<div class="feature-items">
<div class="feature-left d-lg-flex d-grid gap-3 flex-lg-nowrap flex-wrap justify-content-between align-items-center">
<h4><a class="black fw_600 text-nowrap" href="/demo-9/doctor-details">Dr.Harry Kane</a>
</h4>
<ul class="feature-list d-flex flex-column gap-1">
<li class="text-nowrap">
                                        Eye Spacilist
