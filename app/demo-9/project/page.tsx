...
<div class="project-items position-relative">
<div class="project-thumb d-center position-relative rounded-4 overflow-hidden reveal-left mb-4">
<img alt="img" class="w-100 rounded-4" src="/demo-9/assets/img/blog/project5.jpg"/>
<a class="project-arrws p1-bg d-center rounded-circle" href="/demo-9/project-details">
<img alt="icon" src="/demo-9/assets/img/icon/arrow-right-black.png"/>
</a>
</div>
...
<h4><a class="black fw_700 wow fadeInUp" data-wow-delay="0.4s" href="/demo-9/project-details">Tomorrow's Health,
                                    Today's Care</a></h4>
</div>
</div>
</div>
...
<div class="project-items position-relative">
<div class="project-thumb d-center position-relative rounded-4 overflow-hidden reveal-left mb-4">
<img alt="img" class="w-100 rounded-4" src="/demo-9/assets/img/blog/project6.jpg"/>
<a class="project-arrws p1-bg d-center rounded-circle" href="/demo-9/project-details">
<img alt="icon" src="/demo-9/assets/img/icon/arrow-right-black.png"/>
</a>
</div>
...
<h4><a class="black fw_700 wow fadeInUp" data-wow-delay="0.4s" href="/demo-9/project-details">Your Health, Our
                                    Priority</a></h4>
</div>
</div>
</div>
