        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="footer-widget footer-col-1 mb-70">
                ...
                <div className="footer-content">
                  <p>Vamary is a premium aesthetic surgery center providing quality care and procedures.</p>
            ...
            <div className="col-xl-3 col-lg-3 col-md-6">
              <div className="footer-widget footer-col-2 mb-70">
                <span className="footer-title">Services</span>
                <div className="footer-link">
                  <ul>
                    <li><Link href="/demo-12/service-details">Breast Implant Safety</Link></li>
                    <li><Link href="/demo-12/service-details">Surgery Preparation</Link></li>
                    <li><Link href="/demo-12/service-details">Breast Implants</Link></li>
                    <li><Link href="/demo-12/service-details">Lips Surgery</Link></li>
                    <li><Link href="/demo-12/service-details">Non Surgical Procedures</Link></li>
                    <li><Link href="/demo-12/service-details">Pender Unity Care</Link></li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="col-xl-6 col-lg-5 col-md-8">
              <div className="footer-widget footer-col-3 mb-70">
                <span className="footer-title">Our Pages</span>
                <div className="footer-link">
                  <ul>
                    <li><Link href="/demo-12">Home</Link></li>
                    <li><Link href="/demo-12/about">About</Link></li>
                    <li><Link href="/demo-12/pricing">Pricing</Link></li>
                    <li><Link href="/demo-12/shop">Shop</Link></li>
                    <li><Link href="/demo-12/doctor">Doctor</Link></li>
                    <li><Link href="/demo-12/contact">Contact</Link></li>
                  </ul>
                </div>
                <div className="footer-newsletter">
                  <span className="footer-title pt-65">Subscribe Newsletter</span>
            ...
            <div className="row">
              <div className="col-lg-12 col-12">
                <div className="footer-copyright text-center">
                  <span>Copyright © 2026 Vamary. All Rights Reserved.</span>
                </div>
              </div>
            </div>
          </div>
