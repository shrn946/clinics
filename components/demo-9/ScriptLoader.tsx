...
const scripts = [
  "/demo-9/assets/js/jquery-3.7.1.min.js",
  "/demo-9/assets/js/viewport.jquery.js",
  "/demo-9/assets/js/bootstrap.bundle.min.js",
  "/demo-9/assets/js/jquery.nice-select.min.js",
  "/demo-9/assets/js/jquery.waypoints.js",
  "/demo-9/assets/js/jquery.counterup.min.js",
  "/demo-9/assets/js/swiper-bundle.min.js",
  "/demo-9/assets/js/jquery.meanmenu.min.js",
  "/demo-9/assets/js/jquery.magnific-popup.min.js",
  "/demo-9/assets/js/wow.min.js",
  "/demo-9/assets/js/gsap.min.js",
  "/demo-9/assets/js/lenis.min.js",
  "/demo-9/assets/js/scrollSmoother.js",
  "/demo-9/assets/js/ScrollTrigger.min.js",
  "/demo-9/assets/js/spilitext-gsap.js",
  "/demo-9/assets/js/vanilla-tilt.min.js",
  "/demo-9/assets/js/main.js"
];
...
export default function ScriptLoader() {
  ...
  useEffect(() => {
    ...
    if (!document.querySelector('script[src="/demo-9/assets/js/main.js"]')) {
      let currentIdx = 0;
