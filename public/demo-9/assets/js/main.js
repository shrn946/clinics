...
(function ($) {
	...
	$(document).ready(function () {
		...
		window.initMedizenAnimations = function() {
			...
			if (btnVivacity && typeof VanillaTilt !== 'undefined') {
		...
		var terElementParagraph = $("p");
		$(terElementParagraph).on("mouseenter mouseleave", function () {
			$(".mouse-follower").toggleClass("highlight-cursor-para");
			$(this).toggleClass("highlight-cursor-para");
		});

		// Initial animation invocation
		window.initMedizenAnimations();
	...
	function loader() {
		...
		// Safety fallback to guarantee preloader is hidden quickly
